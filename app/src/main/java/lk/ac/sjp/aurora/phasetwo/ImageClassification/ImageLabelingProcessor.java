...
package lk.ac.sjp.aurora.phasetwo.ImageClassification;
...
public class ImageLabelingProcessor extends VisionProcessorBase<List<FirebaseVisionLabel>> {
    ...
    public ImageLabelingProcessor(Activity activity) {
    ...
    protected void onSuccess(
        ...
        //TODO: Add logic to select which post was scanned and push that to the state
